...
When does phase get passed on to the Agents?
...
> ---
> 
> **Would you like me to update main_orchestrator.py to pass the phase and show how to load a code file into the canvas for the agents to work on?**
